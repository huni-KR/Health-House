...
import com.ssafy.vue.service.BookService;
...
public class BookRestController {
	...
	@GetMapping("/{no}")
	public ResponseEntity<BookDto> searchBook(@PathVariable int no) {
		logger.debug("searchBook - 호출");
		return new ResponseEntity<>(bookService.search(no), HttpStatus.OK);
	}
	...
	@DeleteMapping("{no}")
	public ResponseEntity<String> deleteBook(@PathVariable("no") int no) {
